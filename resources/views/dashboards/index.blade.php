                ...
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="{{ url('tables/rfid') }}" class="nav-link">
                      ...
                      <span class="sidenav-normal"> RFID Tag </span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ url('tables/box') }}" class="nav-link">
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Total Tag RFID</h5>
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Total Type Box</h5>
