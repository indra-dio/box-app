      ...
      <div class="row">
        <div class="col">
            <div class="card">
              ...
              <!-- Card body -->
              <div class="card-body">
                <form action="{{ route('rfid.add-data-rfid') }}" method="POST">
                  @csrf
                    <div class="form-row">
                      <div class="col-md-4 mb-3">
                        <div class="form-group">
                          <label class="form-control-label" for="validationDefaultTag">Tag</label>
                          <input type="text" class="form-control" id="tag_rfid" name="tag_rfid" required>
                        </div>
                      </div>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                      <div class="col-md-4 mb-3">
                        <div class="form-group">
                          <label class="form-control-label" for="validationDefaultUsername">Status</label>
                          <select class="form-control" id="status" name="status" data-toggle="select" data-live-search="true" required>
                  ...
                  <button class="btn btn-primary" type="submit">Add RFID</button>
                </form>
              </div>
            </div>
        </div>
